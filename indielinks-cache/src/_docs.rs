...
//! synchronizes (a typically small amount of) state across a cluster of nodes. It doesn't guarantee
...
//! 2. once things are working the application wants to move to gRPC for performance reasons
//!
...
//!
//! It's important to realize that cluster membership never changes automatically; members may go
